...
const classReport_routes_1 = __importDefault(require("./routes/classReport.routes"));
...
const contactMessage_routes_1 = __importDefault(require("./routes/contactMessage.routes"));
...
app.use("/api/v1/class-reports", classReport_routes_1.default);
