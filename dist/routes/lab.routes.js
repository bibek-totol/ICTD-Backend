...
router.get("/public", lab_controller_js_1.getLabsPublic);
router.get("/filter-optionspublic", lab_controller_js_1.getFilterOptionsPublic);
router.get("/unified-labspublic", lab_controller_js_1.getAllLabsUnifiedPublic);
router.get("/:idpublic", lab_controller_js_1.getLabByIdPublic);
