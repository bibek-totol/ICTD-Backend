...
import { createAnnouncement, getAnnouncements, getActiveAnnouncements, updateAnnouncement, deleteAnnouncement } from "../controllers/announcement.controller";
...
router.post("/create", SuperAdminAuthorizationMiddleware, announcementUpload.single("file"), createAnnouncement);
router.put("/update/:id", SuperAdminAuthorizationMiddleware, announcementUpload.single("file"), updateAnnouncement);
