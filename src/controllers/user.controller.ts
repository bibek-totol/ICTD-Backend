  ...
  try {
    ...
    const newUser = await prisma.user.create({
      data: {
        ...
        imageUrl:
          imageUrl?.trim() || 'https://www.iconpacks.net/icons/2/free-user-icon-3296-thumb.png',
      ...
      usersToInsert.push({
        ...
        phoneNumber: user.mobile
          ...
          : user.phoneNumber
            ...
            : null,
        altPhoneNumber: user.alt_mobile
          ? String(user.alt_mobile)
          : user.altPhoneNumber
            ? String(user.altPhoneNumber)
            : null,
