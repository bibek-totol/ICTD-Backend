...
const buildReportData = (body: any) => {
  ...
  return {
    ...
    digitalLabStatusDetails:
      body.digitalLabStatusDetails || reportDetails?.digitalLabStatusDetails || null,
    renovationRouteStatus:
      body.renovationRouteStatus || reportDetails?.renovationRouteStatus || null,
    renovationRouteStatusDetails:
      body.renovationRouteStatusDetails || reportDetails?.renovationRouteStatusDetails || null,
    renovationRouteDetails:
      body.renovationRouteDetails || reportDetails?.renovationRouteStatusDetails || null,
    labClassRegister: body.labClassRegister || reportDetails?.labClassRegister || null,
    labClassRegisterDetails:
      body.labClassRegisterDetails || reportDetails?.labClassRegisterDetails || null,
    labCameraStatus: body.labCameraStatus || reportDetails?.labCameraStatus || null,
    labCameraStatusDetails:
      body.labCameraStatusDetails || reportDetails?.labCameraStatusDetails || null,
    internetConnectionStatus:
      body.internetConnectionStatus || reportDetails?.internetConnectionStatus || null,
    internetConnectionStatusDetails:
      body.internetConnectionStatusDetails ||
      reportDetails?.internetConnectionStatusDetails ||
      null,
    internetConnectionDetails:
      body.internetConnectionDetails || reportDetails?.internetConnectionStatusDetails || null,
...
const getScopedWhereClause = (req: Request) => {
  ...
  if (Object.keys(labClause).length > 0 || Object.keys(ictdlClause).length > 0) {
    andClause.push({
      OR: [{ lab: { ...labClause } }, { ictdlLab: { ...ictdlClause } }],
    });
  }
...
const mapClassReport = (report: any) => {
  ...
  return {
    ...
    renovationRouteStatusDetails:
      report.renovationRouteStatusDetails || report.renovationRouteDetails,
    ...
    internetConnectionStatusDetails:
      report.internetConnectionStatusDetails || report.internetConnectionDetails,
