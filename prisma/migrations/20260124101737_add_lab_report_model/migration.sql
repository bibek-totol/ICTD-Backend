...
CREATE TABLE "LabReport" (
    ...
    "basicRobotics" INTEGER NOT NULL DEFAULT 0,
    "advancedRobotics" INTEGER NOT NULL DEFAULT 0,
    "threeDPrinter" INTEGER NOT NULL DEFAULT 0,
    "vrHeadset" INTEGER NOT NULL DEFAULT 0,
    "networkCamera" INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "LabReport" ADD CONSTRAINT "LabReport_labId_fkey" FOREIGN KEY ("labId") REFERENCES "labs"("id") ON DELETE CASCADE ON UPDATE CASCADE;
